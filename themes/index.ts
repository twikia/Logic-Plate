...
export const Themes: Record<string, ThemeColors> = {
  neon_dark: {
    name: 'Neon Dark',
    gradient: ['#000000', '#050515'],
    cardBackground: 'rgba(5,5,20,0.96)',
    accent: '#00FFFF',
    text: '#FFFFFF',
    subtext: 'rgba(255,255,255,0.65)',
    tint: '#00FFFF',
    buttonBackground: 'rgba(0,255,255,0.08)',
    glassBackground: 'rgba(0,255,255,0.06)',
    buttonShape: 'pill',
    cardBorderColor: 'rgba(0,255,255,0.45)',
    cardShadowColor: '#00FFFF',
    matchOrbColors: ['#00FFFF', '#0088FF'],
    radarGridColor: 'rgba(255,255,255,0.12)',
    pageTitleColor: '#00FFFF',
    neonColors: ['#00FFFF', '#9400FF', '#FF00FF', '#00FFFF'],
  },
  soft_paper: {
    name: 'Soft Paper',
    gradient: ['#F5EDE0', '#EBE1D0'],
