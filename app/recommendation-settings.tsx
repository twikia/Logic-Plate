...
const styles = StyleSheet.create({
  ...
  sectionLabel: { fontSize: 13, fontWeight: '800', letterSpacing: 0.8, marginBottom: 10, textTransform: 'uppercase', textAlign: 'center' },
  sectionIntro: { fontSize: 13, lineHeight: 19, marginBottom: 14, textAlign: 'center' },
  metricSection: { borderRadius: 14, padding: 14, marginBottom: 12 },
  metricSectionTitle: { fontSize: 16, fontWeight: '800', marginBottom: 4, textAlign: 'center' },
  metricSectionSub: { fontSize: 12, marginBottom: 12, lineHeight: 17, textAlign: 'center' },
  resetBtn: {
    borderWidth: 1,
    borderRadius: 14,
    paddingVertical: 12,
  ...
  cuisineHint: { fontSize: 12, marginBottom: 10, lineHeight: 17, textAlign: 'center' },
